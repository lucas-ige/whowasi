...
def test_IgnoreRule_test_path():
    ...
    assert IgnoreRule("**/.DS_Store").test_path(".DS_Store")
    assert IgnoreRule("**/.DS_Store").test_path("foo/bar/.DS_Store")
    assert not IgnoreRule("**/*.py").test_path("hello.py_")
    assert not IgnoreRule("**/*.py").test_path("foo/hello.py_")
    assert not IgnoreRule("**/*.py").test_path("foo/bar/hello.py_")
    assert not IgnoreRule("foo/**/*.py").test_path("foo/hello.py_")
    assert not IgnoreRule("foo/**/*.py").test_path("foo/bar/hello.py_")
    assert not IgnoreRule("foo/**/*.py").test_path("foo/bar/ter/hello.py_")
    assert IgnoreRule("foo/**").test_path("foo/hello.py_")
    assert IgnoreRule("foo/**").test_path("foo/bar/hello.py_")
    assert not IgnoreRule("foo/bar/*.py").test_path("foo/bar/hello.py_")
    assert not IgnoreRule("foo/bar/*.py").test_path("foo/bar/world.py_")
